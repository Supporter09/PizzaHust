      ...
      {summary && (
        <div className="mt-3 text-sm text-gray-700">
          <div className="flex gap-4">
            <span className="text-green-700">Created: {summary.created}</span>
            <span className="text-blue-700">Updated: {summary.updated}</span>
            <span className="text-gray-500">Skipped: {summary.skipped}</span>
          </div>
...
export default function ImportPage() {
  return (
    <div>
      ...
      <h1 className="mb-2 text-2xl font-semibold text-gray-900">Bulk Import</h1>
